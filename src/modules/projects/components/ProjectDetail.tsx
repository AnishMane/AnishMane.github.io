...
import { hardcodedProjects } from '@/common/data/projectsData'; // Import hardcodedProjects
...
const ProjectDetail = () => {
  ...
  const project = hardcodedProjects.find((project) => project.slug === slug);

  if (!project) {
    return <div>Project not found</div>;
  }

  const { title, image, stacks, link_demo, link_github, content } = project;
